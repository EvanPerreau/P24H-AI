...
class Scoring:
    def __init__(self, monstres: list[Monstre], cartes: list[Pioche], me: Joueur, fdr: int):
        """
    ...
    def set_score_monstres(self):
        ...
        for monstre in self.monstres:
            ...
            if self.me.score_attaque >= monstre.vie:
    ...
    def set_score_cartes(self):
        ...
        for carte in self.cartes:
            ...
            if carte.type_carte == TypeCarte.DEFENSE:
                ...
                if self.fdr > self.me.score_defense:
                    defense = self.fdr - self.me.score_defense
                    multiplicateur_fdr = 1 + defense / 10

                multiplicateur_hard_danger = 1
                if self.fdr > self.me.score_defense + self.me.vie:
